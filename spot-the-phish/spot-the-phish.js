...
const emails = [
    ...
    {fromName:"IT Support",fromEmail:"support@school.edu",subject:"Password Expired",date:"Fri, 15 Nov 2025 11:30 AM",attachments:[],body:"Your password expired today. Reset using the link below.",correct:"infected",difficulty:"Medium"},
    {fromName:"HR Department",fromEmail:"hr@school.edu",subject:"Policy Update",date:"Mon, 18 Nov 2025 08:00 AM",attachments:[{name:"policy.docx",size:"22 KB"}],body:"Please review the updated policy.",correct:"safe",difficulty:"Easy"},
    ...
    {fromName:"Event Team",fromEmail:"event@school.edu",subject:"Upcoming Event Details",date:"Tue, 20 Nov 2025 10:00 AM",attachments:[{name:"EventDetails.pdf",size:"45 KB"}],body:"Details of upcoming school event.",correct:"safe",difficulty:"Medium"},
    ...
    {fromName:"Tech Support",fromEmail:"support@school.edu",subject:"Install New Software",date:"Fri, 23 Nov 2025 15:45 PM",attachments:[{name:"software.exe",size:"120 MB"}],body:"Install the latest software to improve performance.",correct:"infected",difficulty:"Medium Hard"},
    {fromName:"Newsletter",fromEmail:"news@school.edu",subject:"Weekly Updates",date:"Sat, 24 Nov 2025 08:30 AM",attachments:[{name:"updates.pdf",size:"10 KB"}],body:"Here are this week’s school updates.",correct:"safe",difficulty:"Medium"}
];
...
function loadEmail(){
    ...
    emailContainer.innerHTML=`
        <p style="font-size:1.5em;"><strong>From:</strong> ${m.fromName} &lt;${m.fromEmail}&gt;</p>
        <p style="font-size:1.5em;"><strong>Subject:</strong> ${m.subject}</p>
        <p style="font-size:1.5em;"><strong>Date:</strong> ${m.date}</p>
        <p style="font-size:1.6em;">${m.body}</p>
        ${att}`;
...
// EVENTS
// ========================
setTimeout(()=>{document.getElementById("intro-screen").style.display="none"; startScreen.style.display="flex";},10000);
